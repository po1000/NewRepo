    ...
    <section
      ...
      {isSubmitted ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label htmlFor="reset-email" className="block text-[11.9px] font-medium text-[#374151] leading-5 mb-2">
              Email Address
            </label>
            <input
              type="email"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-[44px] mt-4 bg-[#FF4D01] hover:bg-[#E64500] disabled:opacity-60 text-white font-semibold text-[13.6px] rounded-lg transition-colors">
