...
export const SPANISH_DICT: Map<string, string> = new Map([
  ...
  ['tren', 'train'], ['autobús', 'bus'], ['autobus', 'bus'],
  ['metro', 'metro'], ['parada', 'stop'], ['billete', 'ticket'],
  ['mapa', 'map'], ['aeropuerto', 'airport'], ['taxi', 'taxi'],
  ...
  ['queso', 'cheese'], ['jamón', 'ham'], ['jamon', 'ham'],
  ['naranja', 'orange'], ['manzana', 'apple'], ['plátano', 'banana'],
  ['platano', 'banana'], ['tomate', 'tomato'], ['ensalada', 'salad'],
  ['pollo', 'chicken'], ['pescado', 'fish'], ['carne', 'meat'],
  ['verdura', 'vegetable'], ['fruta', 'fruit'],
  ['kilo', 'kilo'], ['gramo', 'gram'],
  ['barato', 'cheap'], ['caro', 'expensive'],
  ['bonita', 'pretty (f.)'], ['bueno', 'good'], ['buena', 'good (f.)'],
  ['todo', 'all'], ['todos', 'all (pl.)'],
  ['otro', 'other'], ['otra', 'other (f.)'],
  ['mismo', 'same'], ['cada', 'each'],
