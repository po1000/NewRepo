...
export function Community({
  ...
  return (
    <div className="min-h-screen w-full bg-[#FFDFFC] font-inter relative overflow-hidden">
      ...
      <div className="max-w-[940px] mx-auto px-4 sm:px-6 relative z-10">
        <div className="relative flex flex-col pt-[42px]">
          ...
          <div className="[&_a]:text-[#372213] [&_button]:text-[#372213] [&_svg]:text-[#372213]">
            <Navigation
        ...
        {/* Main Content */}
        <div className="max-w-[684px] mx-auto pt-12 pb-20">
          {/* Header */}
          <div className="flex flex-col items-center gap-2 mb-10 text-center">
            ...
            <p className="font-inter text-[13.6px] leading-[24px] text-[#4B5563]">
              Ask questions, share tips, and learn together with fellow Spanish
              learners
            </p>
          </div>
          ...
          <div className="flex gap-3 overflow-x-auto pb-4 mb-6 no-scrollbar">
            ...
            <button
              key={section}
              className={`whitespace-nowrap px-5 py-2.5 rounded-full font-inter font-medium text-[14px] transition-colors ${i === 0 ? 'bg-[#372213] text-white' : 'bg-white text-[#4B5563] hover:bg-gray-50 border border-[#E5E7EB]'}`}>
            ...
            <motion.div
              ...
              className="bg-white rounded-xl border border-[#E5E7EB] shadow-sm p-6 mb-6 overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-inter font-bold text-[18px] text-[#372213]">
                    Ask a Question
                  </h3>
                  <button
                ...
                setExpandedPost(expandedPost === post.id ? null : post.id)
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex flex-col items-center gap-1">
                      ...
                      <span className="font-inter font-bold text-[14px] text-[#372213]">
                        {post.upvotes}
                      </span>
                      <button
                      onClick={(e) => {
                    ...
                    <div className="flex-1 flex flex-col gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-inter font-medium text-[13px] text-[#4B5563]">
                          {post.author}
                        </span>
                        <span className="font-inter text-[13px] text-[#9CA3AF]">
                          • {post.timeAgo}
                        </span>
                      ...
                      <h2 className="font-inter font-bold text-[18px] leading-[26px] text-[#372213]">
                        {post.title}
                      </h2>

                      {post.body &&
                    <p className="font-inter text-[14px] leading-[22px] text-[#4B5563] mt-1">
                          {post.body}
                        </p>
                    }
              ...
              <div className="border-t border-[#E5E7EB] bg-gray-50/50 p-5">
                ...
                <>
                        <div className="flex items-center justify-between mb-6">
                          <span className="font-inter font-semibold text-[15px] text-[#372213]">
                            Top Responses
                          </span>
                        </div>
                    ...
                    <div key={comment.id} className="flex gap-3">
                              <div className="flex flex-col items-center gap-1 mt-1">
                                <button
                          onClick={() =>
                          handleCommentVote(post.id, comment.id, 'up')
                          }
                          className={`transition-colors ${comment.userVote === 'up' ? 'text-[#FF4D01]' : 'text-[#9CA3AF]'}`}>
                          
                                  <ArrowUp className="w-4 h-4" />
                                </button>
                                <span className="font-inter font-bold text-[12px] text-[#372213]">
                                  {comment.upvotes}
                                </span>
                                <button
                          onClick={() =>
                          ...
                          className={`transition-colors ${comment.userVote === 'down' ? 'text-[#FF4D01]' : 'text-[#9CA3AF]'}`}>
                              ...
                              <div className="flex-1 flex flex-col gap-2">
                                <div className="flex items-center gap-2">
                                  <span className="font-inter font-medium text-[13px] text-[#372213]">
                                    {comment.author}
                                  </span>
                                  <span className="font-inter text-[12px] text-[#9CA3AF]">
                                    • {comment.timeAgo}
                                  </span>
                                </div>
                                <p className="font-inter text-[14px] leading-[22px] text-[#4B5563]">
                                  {comment.text}
                                </p>
